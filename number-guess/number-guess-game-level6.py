...
while True:
    ...
    if playerİnput == 'p' or playerİnput == 'P':
        print('Starting game ...(Press S to unlock cheat mode, Press X Return the menu, Press M turn on the motion mode)')
        while True:
    ...
    #Debug mode
        ...
        print('Starting debug mode ...(Press D Exit the debug mode, Press M turn on the motion mode)')
        while True:
            ...
            if playerNum == 'm' or playerNum == 'M':
                if motion == 0:
                    ...
                    motion = 0
                    print('Motion mode turned off')
            elif playerNum == 'd' or playerNum == 'D':
                print('Returning to the menu')
                break
            elif num == int(playerNum):
                numberGuess += 1
